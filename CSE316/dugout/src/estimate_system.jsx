                ...
                {Object.entries(goldenGloves).map(([pos, player]) => (
                    <div key={pos} className={`player-wrapper pos-${pos}`}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="80" height="55" viewBox="0 0 136 90" className="uniform-svg">
                            ...
                            <path d="M88.643 1.29449C88.643 4.22863 79.3449 6.60721 67.8751 6.60721C56.4053 6.60721 47.1072 4.22863 47.1072 1.29449C83.3001 -0.637726 63.9811 5.64077 67.8751 1.29399C76.5385 4.67497 67.3619 1.29403 88.643 1.29449Z" fill="#D9D9D9"/>
